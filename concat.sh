...
rm marker.csv # remove temp file
csvstack $(find data -type f -exec echo -n '{} ' \;) > restaurants.csv # combine csvs
csvjson restaurants.csv --lat lat --lon lng -i 2 > restaurants.geojson # convert to geojson
